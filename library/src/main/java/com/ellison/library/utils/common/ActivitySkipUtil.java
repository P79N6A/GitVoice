...
public class ActivitySkipUtil {
	 ...
	 * @return void 返回类型
	 */
	public static void skipActivity(Context context, Class<?> cla) {
		if (context != null) {
	...
	public static void skipActivity(Activity activity, Class<?> cla) {
		if (activity != null) {
			...
			activity.overridePendingTransition(R.anim.library_slide_in_right, R.anim.library_slide_out_left);
		}
	}
	...
	public static void skipActivity(Fragment fragment, Class<?> cla) {
		if (fragment != null) {
			...
			fragment.getActivity().overridePendingTransition(R.anim.library_slide_in_right, R.anim.library_slide_out_left);
		}
	}
