...
public class AddCommaToMoney {
    ...
    public static String formatMoney(String money) {
        return AddCommaToMoney(String.valueOf(DecimalPlaces.roundByScale(Double.valueOf(money), 3)));
    }


    private static String AddCommaToMoney(String money) {
        symbol = null;
        if (money.contains("-")) {
            symbol = "-";
            money = money.replace("-", "");
