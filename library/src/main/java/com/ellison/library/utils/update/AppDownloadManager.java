package com.ellison.library.utils.update;
...
public class AppDownloadManager {
    ...
    public AppDownloadManager(Activity activity) {
        ...
        appName = activity.getResources().getString(R.string.app_name) + ".apk";
    }
    ...
    private void updateView() {
        ...
        L.i("下载进度：" + bytesAndStatus[0] + "/" + bytesAndStatus[1] + "");
    }
    ...
    private void installApk(Context context, Intent intent) {
        ...
        if (completeDownLoadId == mReqId) {
            if (Build.VERSION.SDK_INT < Build.VERSION_CODES.M) {
                ...
                uri = FileProvider.getUriForFile(context, Constants.authProvider,
